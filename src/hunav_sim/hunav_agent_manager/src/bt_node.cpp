...
// AMM / mrht simulation -->
  goal_sub_ = this->create_subscription<hunav_msgs::msg::AgentGoal>(
      "/hunav/set_agent_goal", 10,
      std::bind(&AgentManager::dynamicGoalCallback, &btfunc_.getAgentManager(), std::placeholders::_1));
// <-- AMM / mrht simulation      
}

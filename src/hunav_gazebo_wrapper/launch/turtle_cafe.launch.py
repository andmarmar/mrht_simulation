...
def generate_launch_description():
    ...
    value=['/opt/ros/humble/share/turtlebot3_gazebo/models', ':', my_gazebo_models, ':', 
        aws_hospital_models, ':', '/usr/share/gazebo-11/models']
)
    ...
    #         'z_pose': '0.0',
    #         'yaw': gz_Y,
    #         'robot_name': 'burger',  # nombre del modelo TurtleBot3 Burger
    #     }.items()
    # )
    ...
    # Evento para lanzar el spawn tras arrancar Gazebo
    ...
    # )
    declare_arg_world = DeclareLaunchArgument(
        'base_world', default_value='hospital.world',
        description='Specify world file name'
    )
